    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$4, 4, 2, 82);
    			attr_dev(a1, "href", "/about");
    			add_location(a1, file$4, 5, 2, 114);
    			attr_dev(header, "class", "svelte-1ty96vn");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("Cascadia: ");
    			a = element("a");
    			a.textContent = "Public Template Repository";
    			add_location(h1, file$2, 0, 0, 0);
    			attr_dev(a, "href", "https://github.com/trmid/cascadia");
    			add_location(a, file$2, 2, 11, 29);
    			add_location(p, file$2, 1, 0, 14);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-bcteen");
